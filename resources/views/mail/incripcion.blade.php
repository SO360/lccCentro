...
<table class="container" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%;">
  ...
  <tbody>
    <tr>
      ...
      <h4 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 24px; line-height: 28.8px;" align="center">Gracias por Inscribirse</h4>
...
{{ $curso }}
    ...
    Recordar : Una vez que revisado y aprobada su incripción, se le enviará un correo de confirmación de aceptación del curso.
